  ...
  if (!activeProject) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-slate-600 p-6">
        ...
        <p className="text-xs text-slate-700 mb-4">Select a project to use the Script Writer.</p>
        ...
        {state.creativeProjects.length === 0 && (
          <Link to="/app/projects" className="mt-3 text-xs text-brand-400">+ Create a project →</Link>
        )}
      </div>
    )
  }
